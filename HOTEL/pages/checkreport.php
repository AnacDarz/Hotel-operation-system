...
$rs=mysqli_query($mysqli,"select * from reports where status = 'Checkin' or status = 'Checkout' ");
?>
...
<script type="text/javascript">
    function PrintTable() {
        ...
        printWindow.document.write('<html><head><h1>Hotel Operation </h1> <h5>Checkin/Checkout Reports</h5>');
      ...
      <ul class="navbar-nav">
        <li class="nav-item">
         ...
         <a class="nav-link text-white " href="../pages/reservationfee.php">
          ...
          <li class="nav-item">
          <a class="nav-link text-white active"style="background-color: #FFF01F" href="../pages/checkreport.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active "  aria-current="page">Checked in/out report</li>
          </ol>
          <h6 class="font-weight-bolder mb-0" >Checked in/out report </h6>
        </nav>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2" >
              <div class=" shadow-primary border-radius-lg pt-4 pb-3" style="background-color: #FFF01F;" >
                <h6 class=" text-capitalize ps-3" style="color: rgb(0,0,0);">Checked in/out report</h6>
              </div>
                ...
                <table  class="table table-striped mt32 customers-list" id="myTable">
                  ...
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-uppercase text-danger text-xxs font-weight-bolder opacity-7"onclick="sortBy(3)">Arrival/Departure date</th>
                      ...
                      <th class="text-center text-uppercase text-danger text-xxs font-weight-bolder opacity-7"onclick="sortBy(5)">Assisted By</th>
                        <th class="text-center text-uppercase text-danger text-xxs font-weight-bolder opacity-7"onclick="sortBy(6)">Date</th>
                  ...
                  <?php
                   ...
                   echo " <tr> <td class='align-middle ' style=' padding-left: 1%;'> <span class='text-secondary text-xs font-weight-bold'>".$res['ID']."</span></td>";
                    echo " <td> <div style=' '> <span class='text-secondary text-xs font-weight-bold'>".$res['name']."</h6></div></div></td>";
                    echo " <td><div style=' padding-left: 30%;'> <span class='text-secondary text-xs font-weight-bold'>".$res['rooms']."</h6></div>
                        </div></td>";
                    echo " <td class='align-middle text-center'>
                        <span class='text-secondary text-xs font-weight-bold'>".$res['arrival_date'].' to '.$res['departure_date']."</span>
                      </td>";
