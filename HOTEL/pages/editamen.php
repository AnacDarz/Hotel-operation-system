<?php
include_once("database/dbeditamen.php");
?>

<?php
include_once("dbpasseditamen.php");
?>
  ...
  <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Edit Amenities</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Edit Amenities</h6>
        </nav>
    ...
    <div class="container-fluid px-2 px-md-4">
      ...
      <div class="card card-body mx-3 mx-md-4 mt-n6">
        <form method="post"  action="editamen.php" enctype="multipart/form-data">
            ...
            <div class="col-12 col-xl-4">
              <div class="card card-plain h-100">
                <div class="card-body p-3">
                   <h6 class="text-uppercase text-body text-xs font-weight-bolder">Name of Service</h6>
                 <div class="input-group input-group-outline">
                   <input style="width: 20%" type="hidden" class="form-control" name="newid" value="<?php  echo $ID; ?>"    required/>
              <input style="width: 20%" type="text" class="form-control" name="services" value="<?php  echo $services; ?>"    required/>
            ...
            <div class="col-12 col-xl-4">
              <div class="card card-plain h-100">
                <div class="card-body p-3">
                 ...
                 <div class="input-group input-group-outline">
              <input style="width: 20%" type="number" class="form-control" name="price" value="<?php  echo $price; ?>"     min="0" required/>
