...
$rs=mysqli_query($mysqli,"select * from services ");
?>
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  active"style="background-color: #FFF01F"  href="../pages/viewservice.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active "  aria-current="page">View Services</li>
          </ol>
          <h6 class="font-weight-bolder mb-0" >View Services </h6>
        </nav>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2" >
              <div class=" shadow-primary border-radius-lg pt-4 pb-3" style="background-color: #FFF01F;" >
                <h6 class=" text-capitalize ps-3" style="color: rgb(0,0,0);">View Services</h6>
              </div>
            </div>
              ...
              <div class="table-responsive p-0">
                ...
                <?php  
                   while ( $res=mysqli_fetch_array($rs)) {
                    ...
                    echo " <td> <div class='d-flex px-2 py-1'><div></div><div class='d-flex flex-column justify-content-center'><h6 class='mb-0 text-sm'>".$res['service_name']."</h6></div></div></td>";
                    echo " <td> <div class='d-flex px-2 py-1'><div></div><div class='d-flex flex-column justify-content-center'><h6 class='mb-0 text-sm'>".$res['price']."</h6></div>
                                   ...
                                   <a href='editservice.php?ID=$res[ID]'class='text-success font-weight-bold text-xs' data-original-title='Edit user' style='padding-right: 10%'>
                                    Edit </a>

                                    <a href='removeservice.php?ID=$res[ID]' class='text-primary font-weight-bold text-xs' data-toggle='tooltip' data-original-title='Edit user'>
                                     Remove</a> </td></tr>";
