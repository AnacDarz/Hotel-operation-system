...
$rs=mysqli_query($mysqli,"select * from reservation where requestin='Pending' or requestin='Ongoing'");
?>
...
<body class="g-sidenav-show  bg-gray-200">
 <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="../pages/housekeepingdashboard.php" target="_blank">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active"style="background-color: #FFF01F" href="../pages/requestinformation.html">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active "  aria-current="page">Request Information</li>
          </ol>
          <h6 class="font-weight-bolder mb-0" >Request Information </h6>
        </nav>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2" >
              <div class=" shadow-primary border-radius-lg pt-4 pb-3" style="background-color: #FFF01F;" >
                <h6 class=" text-capitalize ps-3" style="color: rgb(0,0,0);">Request Information</h6>
              </div>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-danger text-xxs font-weight-bolder opacity-7">Request</th>
                      <th class="text-center text-uppercase text-danger text-xxs font-weight-bolder opacity-7">Services</th>
                      <!--<th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Special Request</th>
                ...
                <?php  
                   while ( $res=mysqli_fetch_array($rs)) {
                    ...
                    echo "  <td class='align-middle ' style=' padding-left: 2%;'>
                        <span class='text-secondary text-xs font-weight-bold'>".'Extra '.$res['request'].' '.$res['other_request']."  Kids</span>
                     </td>";
                     echo " <td class='align-middle text-center'>
                           <span class='text-secondary text-xs font-weight-bold'>".$res['service_name']."</span>
                      </td>";
                      echo "  <td class='align-middle' style=' padding-left: 2%;'>
                        <span class='badge badge-sm bg-gradient-warning'>".$res['requestin']."</span>
                     </td>";
                                ...
                                if (strcmp($type,"Pending")==0) {
                                   ...
                                   <a href='tobedone.php?ID=$res[ID]'class='text-success font-weight-bold text-xs' data-original-title='Edit user' style='padding-right: 10%'>
                                    Approve </a>
                                   ...
                                   <a href='donereq.php?ID=$res[ID]'class='text-success font-weight-bold text-xs' data-original-title='Edit user' style='padding-right: 10%'>
                                    Approve </a>
