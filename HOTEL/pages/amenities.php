...
$rs=mysqli_query($mysqli,"select * from reports where status='Checkout'");
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <title>Amenities | Hotel Operation
  </title>
  <!--     Fonts and icons     -->
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active "  aria-current="page">Amenities</li>
          </ol>
          <h6 class="font-weight-bolder mb-0" >Amenities </h6>
        </nav>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2" >
              <div class=" shadow-primary border-radius-lg pt-4 pb-3" style="background-color: #FFF01F;" >
                <h6 class=" text-capitalize ps-3" style="color: rgb(0,0,0);">Amenities</h6>
              </div>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-danger text-xxs font-weight-bolder opacity-7">Departure date</th>
                  ...
                  <tbody >
                   ...
                   while ( $res=mysqli_fetch_array($rs)) {
                    ...
                    echo " <td> <div class='d-flex px-2 py-1'><div></div><div class='d-flex flex-column justify-content-center'><h6 class='mb-0 text-sm'>".$res['rooms']."</h6></div>
                          ...
                          echo " <td class='align-middle ' style=' padding-left: 5%;' > <div class='d-flex px-2 py-1'><div></div><div class='d-flex flex-column justify-content-center'><h6 class='mb-0 text-sm'>".$res['departure_date']."</h6></div></div></td>";


                     

                     echo "  <td class='align-middle' style=' padding-left: 5%;'>
                     </td> ";
                     ...
                     echo "  <td class='align-middle'>
                                   ...
                                   <a href='manage.php?ID=$res[ID]'class='text-success font-weight-bold text-xs' data-original-title='Edit user' style='padding-right: 10%'>
                                    Manage </a>
