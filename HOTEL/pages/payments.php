...
$rs=mysqli_query($mysqli,"select * from reports ");
?>
...
<script type="text/javascript">
    function PrintTable() {
        ...
        printWindow.document.write('<html><head><h1>Hotel Operation </h1> <h5>Payment Reports</h5>');
          ...
          <li class="nav-item">
           ...
           <a class="nav-link text-white " href="../pages/reservationfee.php">
            ...
            <a class="nav-link text-white " href="../pages/adminreports.php">
             ...
             <li class="nav-item">
            <a class="nav-link text-white active"style="background-color: #FFF01F" href="../pages/payments.php">
              <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active "  aria-current="page">Payment Reports</li>
          </ol>
          <h6 class="font-weight-bolder mb-0" >Payment Reports </h6>
        </nav>
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          <div class="ms-md-auto pe-md-3 d-flex align-items-center">
            <div class="input-group input-group-outline">
              
               <input type="search" class="form-control search-input" id="suppliier" data-table="customers-list"/>
            </div>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2" >
              <div class=" shadow-primary border-radius-lg pt-4 pb-3" style="background-color: #FFF01F;" >
                <h6 class=" text-capitalize ps-3" style="color: rgb(0,0,0);">Payment Reports</h6>


              </div> <div class="input-group input-group-outline">
              ...
              <div class="card-body p-3" >
                 ...
                 <input type="button" style="size: 50%" onclick="PrintTable();" value="Print All" style="border:none;background-color: #0000; padding-left: 90%" class="text-success font-weight-bold text-l " data-toggle="tooltip" data-original-title="Edit user" />

                 <?php
          

            $result = mysqli_query($mysqli,"SELECT sum(payment) FROM reports");
            ...
            ?>
                 ...
                 <h6 style="padding-top: 1%" class=" text-capitalize ps-2" >Total (weekly) :<?php echo number_format(round($rows['sum(payment)'],2),2,'.', '')?> <?php } ?></h6>
                ...
                <table  class="table table-striped mt32 customers-list" id="myTable">
                  ...
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-danger text-xxs font-weight-bolder opacity-7"onclick="sortBy(3)">Payment</th>
                      <th class="text-center text-uppercase text-danger text-xxs font-weight-bolder opacity-7"onclick="sortBy(4)">Type of Transaction</th>
                      <th class="text-center text-uppercase text-danger text-xxs font-weight-bolder opacity-7"onclick="sortBy(5)">Date of payment</th>
                      <th class="text-center text-uppercase text-danger text-xxs font-weight-bolder opacity-7"onclick="sortBy(6)">Assisted By</th>
                  ...
                  <tbody >
                   ...
                   echo " <tr> <td class='align-middle ' style=' padding-left: 1%;'> <span class='text-secondary text-xs font-weight-bold'>".$res['ID']."</span></td>";
                    echo " <td> <span class='text-secondary text-xs font-weight-bold'>".$res['name']."</span></td>";
                    echo " <td> <span class='text-secondary text-xs font-weight-bold'>".$res['rooms']."</span></td>";
