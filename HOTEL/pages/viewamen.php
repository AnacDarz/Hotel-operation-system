...
$rs=mysqli_query($mysqli,"select * from amenity_inventory ");
?>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
         ...
         <li class="nav-item">
          <a class="nav-link text-white " href="../pages/addamen.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
         ...
         <li class="nav-item">
          <a class="nav-link text-white  active"style="background-color: #FFF01F" href="../pages/viewamen.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active "  aria-current="page">View Amenities</li>
          </ol>
          <h6 class="font-weight-bolder mb-0" >View Amenities </h6>
        </nav>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2" >
              <div class=" shadow-primary border-radius-lg pt-4 pb-3" style="background-color: #FFF01F;" >
                <h6 class=" text-capitalize ps-3" style="color: rgb(0,0,0);">View Amenities</h6>
              </div>
            </div>
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-danger text-xxs font-weight-bolder opacity-7 ps-2">Name of Service</th>
                      <th class="text-uppercase text-uppercase text-danger text-xxs font-weight-bolder opacity-7">Price</th>
                ...
                <?php  
                   while ( $res=mysqli_fetch_array($rs)) {
                    ...
                    echo " <td> <div class='d-flex px-2 py-1'><div></div><div class='d-flex flex-column justify-content-center'><h6 class='mb-0 text-sm'>".$res['amenity_name']."</h6></div></div></td>";
                    echo " <td> <div class='d-flex px-2 py-1'><div></div><div class='d-flex flex-column justify-content-center'><h6 class='mb-0 text-sm'>".$res['price']."</h6></div>
                        </div></td>";
                                   ...
                                   <a href='editamen.php?ID=$res[ID]'class='text-success font-weight-bold text-xs' data-original-title='Edit user' style='padding-right: 10%'>
                                    Edit </a>

                                    <a href='removeamen.php?ID=$res[ID]' class='text-primary font-weight-bold text-xs' data-toggle='tooltip' data-original-title='Edit user'>
                                     Remove</a> </td></tr>";
