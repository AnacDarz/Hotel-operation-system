...
include_once("database/dbfd.php");
...
<body class="g-sidenav-show bg-gray-200">
 <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      ...
      <li class="nav-item">
          <a class="nav-link text-white active"style="background-color: #FFF01F" href="../pages/hkprofile.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
    ...
    <form method="post"  action="editmedicine.php" enctype="multipart/form-data">
          ...
          <div class="row">
            <div class="col-12 col-xl-4">
              <div class="card card-plain h-100">
                ...
                <div class="card-body p-3">
                  ...
                  <ul class="list-group">
                    <li class="list-group-item border-0 px-0">
                      <div class="form-check form-switch ps-0">
                        <label class="form-check-label text-body ms-3  w-80 mb-0" for="flexSwitchCheckDefault"><?php echo $email; ?></label>
                      </div>
                    </li>
                  ...
                  <ul class="list-group">
                    <li class="list-group-item border-0 px-0">
                      <div class="form-check form-switch ps-0">
                        <label class="form-check-label text-body ms-3  w-80 mb-0" for="flexSwitchCheckDefault"><?php echo $address; ?></label>
                      </div>
                    </li>
                  ...
                  <ul class="list-group">
                    <li class="list-group-item border-0 px-0">
                      <div class="form-check form-switch ps-0">
                        <label class="form-check-label text-body ms-3  w-80 mb-0" for="flexSwitchCheckDefault"><?php echo $contact; ?></label>
                      </div>
                    </li>
              ...
              <div class="card card-plain h-100">
                ...
                <div class="card-body p-3">
                  <h6 class="text-uppercase text-body text-xs font-weight-bolder">Date</h6>
                  <ul class="list-group">
                    <li class="list-group-item border-0 px-0">
                      <div class="form-check form-switch ps-0">
                        <label class="form-check-label text-body ms-3  w-80 mb-0" for="flexSwitchCheckDefault"><?php echo $datestart; ?> - <?php echo $dateend; ?></label><br>
              ...
              <div class="card card-plain h-100">
                ...
                <div class="card-body p-3">
                  ...
                  <ul class="list-group">
                    <li class="list-group-item border-0 px-0">
                      <div class="form-check form-switch ps-0">
                        <label class="form-check-label text-body ms-3  w-80 mb-0" for="flexSwitchCheckDefault"><?php echo $timestart; ?> - <?php echo $timeend; ?></label><br>
                      </div>
                    </li>
