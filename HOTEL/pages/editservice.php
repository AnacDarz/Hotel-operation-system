<?php
include_once("database/dbeditservice.php");
?>

<?php
include_once("dbpasseditservice.php");
?>
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Edit Services</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Edit Services</h6>
        </nav>
