    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0" >Rooms </h6>
        </nav>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2" >
              <div class=" shadow-primary border-radius-lg pt-4 pb-3" style="background-color: #FFF01F;" >
                <h6 class=" text-capitalize ps-3" style="color: rgb(0,0,0);">Room List</h6>
              </div>
            </div>
            <div class="card-body px-0 pb-2" >
              <div class="table-responsive p-0">
                <table  class="table table-striped mt32 customers-list" id="myTable" >
                  ...
                  <thead>
                    <tr>
                      <th class="text-uppercase text-danger text-xxs font-weight-bolder opacity-7"onclick="sortBy(0)">Room Number</th>
                      <th class="text-center text-uppercase text-danger text-xxs font-weight-bolder opacity-7 ps-2"onclick="sortBy(1)">Image</th>
                      <th class="text-uppercase text-danger text-xxs font-weight-bolder opacity-7 ps-2"onclick="sortBy(2)">Room Type</th>
                      <th class="text-uppercase text-uppercase text-danger text-xxs font-weight-bolder opacity-7"onclick="sortBy(3)">Price</th>
                      ...
                      <th class="text-secondary opacity-7"onclick="sortBy(4)"></th>
                      <th class="text-center text-uppercase text-danger text-xxs font-weight-bolder opacity-7 ps-2"onclick="sortBy(5)">Status</th>
                      <th class="text-secondary opacity-7"></th>
                      <th class="text-secondary opacity-7"></th>    <th class="text-secondary opacity-7"></th>    <th class="text-secondary opacity-7"></th>
                    </tr>
                  </thead>
                  <tbody >
                   ...
                   while ( $res=mysqli_fetch_array($rs)) {
                    ...
                    echo " <tr> <td class='align-middle ' style=' padding-left: 2%;'> <span class='text-secondary text-xs font-weight-bold'>".$res['room_number']."</span></td>
                    <td style='padding: 0; margin: 0;'>"."<div style='text-align: center;padding: 0;' width='4%' height='4%'><img style='padding: 0;' width='40%' height='4%' src=' $image_src'></div>"."</td>";
                    echo " <td> <div class='d-flex px-2 py-1'><div></div><div class='d-flex flex-column justify-content-center'><h6 class='mb-0 text-sm'>".$res['room_type']."</h6></div></div></td>";
...
echo "  <td class='align-middle' style=' padding-left: 5%;'>
                     ...
                     echo "  <td class='align-middle'>
                                   ...
                                   <a href='editroom.php?ID=$res[ID]'class='text-success font-weight-bold text-xs' data-original-title='Edit user' style='padding-right: 10%'>
                                    Edit </a>
                                     <a href='deleteroom.php?ID=$res[ID]'class='text-danger font-weight-bold text-xs' data-original-title='Edit user' style='padding-right: 10%'>
                                    Delete </a>

                                    </td><td class='align-middle' style=' padding-left: 5%;'>
                     </td></tr>";
                                            }
                                           ?>
