...
include_once("config.php");
 ...
 $rs=mysqli_query($mysqli,"select * from rooms where room_type='Junior Suite'");
...
<body onload="onload();">
    ...
    <section class="room-section spad">
        ...
        <form method="post"  action="juniorrm.php">
          ...
          <div class="col-lg-4 " >
            ...
            $dd = mysqli_query($mysqli,"SELECT * from rooms where room_type='Junior Suite'");
 ...
 <div class="col-12 col-xl-4">
              <div class="card card-plain h-100">
                <div class="card-body p-3">
                 ...
                 <div class="input-group input-group-outline">
              <input type="text" class="form-control" value="Junior Suite" name="typerm" readonly="">
            </div>
                </div>
              </div>
            </div>
