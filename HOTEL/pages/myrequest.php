...
<?php
include_once("dbpassmyrequest.php");
?>
         ...
         <div class="h-100">
              ...
              <div class="card card-plain h-100">
                <div class="card-body p-3">
                 ...
                 <div class="input-group input-group-outline">
               <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" name="Sup" id="Supplier">

                <?php  
                        $ros=mysqli_query($mysqli,"select * from services");
                        while ( $res=mysqli_fetch_array($ros)) {
                          ?>
                  <option value="<?php echo $res['service_name']; ?> "><?php echo $res['service_name']; ?> - Php <?php echo $res['price']; ?></option>
  ...
  <div class="col-12 col-xl-4">
              <div class="card card-plain h-100">
               ...
               <select class="form-select form-select-lg mb-3" name="reqs"id="req" aria-label=".form-select-lg example">
                <?php  
                        $ros=mysqli_query($mysqli,"select * from amenity_inventory");
                         while ( $res=mysqli_fetch_array($ros)) {
                          ?>
                           <option value="<?php echo $res['amenity_name']; ?> "><?php echo $res['amenity_name']; ?> - Php <?php echo $res['price']; ?></option>
                 <?php  } ?>
                </select>
                        ...
                        while ( $ros=mysqli_fetch_array($rosa)) {
                                ...
                                if (strcmp($types,"Pending")==0) {
                                   ...
                                   echo "  
                                          ...
                                          <div class='col-12 mt-4' >
                                          <div class='mb-5 ps-3' >";
                                            echo " <button  type='submit' name='submitinfo'class='btn bg-gradient-success'>Request</button>";
                                         echo " <button type='button' class='btn bg-gradient-danger'>Cancel</button>";
                                }else if (strcmp($type,"Fully Paid")==0){
                                   echo "  
                                          <div class='col-12 mt-4' >
...
<script>
    function myFunction() {
        ...
        var value=x.selectElement.options[x.selectedIndex].value;
          ...
          var y = document.getElementById("Supplier");
         document.getElementById("demos").innerHTML = y;
